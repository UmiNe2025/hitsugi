# 開発ステータス(2026-07-05 更新・第二版)

**v3.1目標にほぼ到達**: 神180柱・敵147基礎+変異(_w/_o)・装備810・辞世1370・事件270・地域28・画像2107枚。**キャラアニメ強化**(呼吸2重/lunge3段/victoryJump段階化/待機時歩行コマ循環)完了。**変異絵promptEn 147基礎種全カバー**(nova誤読対策の英語外見記述、変異は自動継承)。
